...
const LoginPage = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      router.push('/parentDashboard'); // Redirect to student dashboard
    } catch (err: any) {
  ...
  return (
    <div className="w-full max-w-md">
      <h1 className="text-2xl md:4xl font-bold text-green-600 mb-6 text-center">Welcome Back To parent's Login</h1>
